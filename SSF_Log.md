...
* 1:30pm-2:10pm: Read through the Landsat 8 Pangeo environment to see how images were being processed using Pangeo and how AWS was utilized. Not as helpful as I had hoped unfortunately.
...
* 3:50pm-4:10pm: Read about using Pangeo on an HPC. Will be dependant on USGS resources I use. Will need to create a Pangeo environment that has tensorflow, matplotlib, pandas, numpy, xarray, dask, PIL, os, skitlearn, skittrain, among other packages.   
* 4:10pm-5pm: Updated Log, emails, and wrote out workflow for creating BRISQUE QC function. 
